...
inline void vector_Point_to_Mat(vector<Point3f>& v_point, Mat& mat) {
...
JNIEXPORT void JNICALL Java_com_polysfactory_n3_jni_NativeMarkerDetector_nativeFindMarkers(
	...
	try {
		...
		std::vector<Point3f> cameraCenters = markerDetector->getCameraCenters();
		vector_Point_to_Mat(cameraCenters, *transMatObj);
	} catch (...) {
